    ...
    return (
        <article className="brands__mainContainer">
            <div className="brands__mainContainer__titleBox">
                ...
                <div className="brands__mainContainer__slider">
                    <div className="brands__mainContainer__slider__cinta" ref={cintaRef}>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo1}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo2}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo3}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo4}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo5}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo6}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo7}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo8}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo9}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo1}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo2}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo3}/>
                        <img className="brand_logo" alt="logo-marca" src={ImgLogo4}/>
            ...
            <div className="brands__mainContainer__imageBox">
                ...
                <img src={ImageBrands} alt="abrazo-pareja" />
